...
def generate_dashboard():
    try:
        # Essayer 'hive-server' (interne docker) puis 'localhost'
        h = "hive-server" if os.path.exists("/.dockerenv") else "localhost"
        conn = hive.Connection(
            host=h, port=10000, database="agri_insight", auth='NOSASL', username="spark"
        )
  ...
  """,
        ...
        plt.tight_layout()
        output_path = "dashboard_agri_insight.png"
